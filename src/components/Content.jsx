    ...
    <>
        <div className="mt-6 flex flex-col items-left lg:flex-row lg:items-start justify-center">
          <div className="text-left mb-4 lg:mr-4">
            <h1 className="bg-gradient-to-r from-indigo-700 via-sky-500 to-emerald-400 text-transparent bg-clip-text scroll-m-20 text-4xl lg:text-5xl font-bold tracking-tight py-0.5 mb-2">
              Sayak Bhunia
            </h1>
