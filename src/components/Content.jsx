    ...
    <>
        <div className="mt-6 flex flex-col items-left lg:flex-row lg:items-start justify-center">
          <div className="text-left mb-4 lg:mr-4">
            <h1 className="text-slate-100 scroll-m-20 text-4xl lg:text-5xl font-bold tracking-tight mb-2">
              Sayak Bhunia
            </h1>
            <h3 className="text-violet-500 scroll-m-20 text-2xl font-semibold tracking-tight mb-4">
             frontend dev & design
            </h3>
            <hr className="w-25 border-t-2 border-dashed border-slate-600 mx-auto mb-4" />
            <h3 className="text-zinc-500 scroll-m-20 text-xl font-semibold tracking-tight mb-4 w-full max-w-80 mt-2">
            ...
            <h3 className="text-gray-100 scroll-m-20 text-xl font-semibold tracking-tight mb-4 w-full max-w-80">
              looking for an internship role as a front-end developer.
            </h3>
            <h3 className="text-zinc-500 scroll-m-20 text-xl font-semibold tracking-tight mb-4 w-full max-w-80">
              hire me → <a href="https://drive.google.com/file/d/1cJWzFQfW8V1uCI4k4jSen7b38QJRB7gJ/view?usp=sharing" target="_blank"><span className="text-violet-500 scroll-m-20 text-xl font-semibold no-underline hover:underline">resume</span></a>
            </h3>
          </div>
          <div className="hidden lg:block">
            <img src="./images/unidp2.jpg" alt="Image Description" className="mt-4 mx-auto lg:mt-0 lg:ml-4 w-full h-80 rounded-xl border-4 hover:border-2 border-custom hover:border-slate-500 transition duration-300 ease-in-out transform hover:scale-105 shadow-md hover:shadow-slate-100 hover:shadow-lg" />
          </div>
        </div>
        <div class="mt-0 flex flex-col items-left lg:flex-row lg:items-start justify-center">
          <div class="text-left mb-4 lg:mr-4">
            <h3 class="text-zinc-500 text-xl font-semibold tracking-tight ml-0">
              in the past 2 years i have won 2 hackathons <a href="https://devfolio.co/projects/coders-dasboard-d8fd" target="_blank"><span className="text-violet-500 scroll-m-20 text-xl font-semibold no-underline hover:underline">Codefest 23</span></a> and <a href="https://devfolio.co/projects/ezmed-cb1e" target="_blank"><span className="text-violet-500 scroll-m-20 text-xl font-semibold no-underline hover:underline">HackOdisha 3.0</span></a>
            </h3>
            <h3 class="text-zinc-500 text-xl font-semibold tracking-tight ml-0">
              and created <a href="https://devdojo.website/" target="_blank"><span className="text-violet-500 scroll-m-20 text-xl font-semibold no-underline hover:underline">Dev Dojo</span></a> (community) , also worked as a PR and MGT Lead
            </h3>
            <h3 class="text-zinc-500 text-xl font-semibold tracking-tight ml-0">
              of <a href="https://gdsc.community.dev/narula-institute-of-technology-agarpara/" target="_blank"><span className="text-violet-500 scroll-m-20 text-xl font-semibold no-underline hover:underline">GDSC NiT</span></a> and worked on numerous projects.
            </h3>
        ...
        <div className="mt-4 flex flex-col items-left lg:flex-row lg:items-start justify-center mr-12">
          <div className="text-left mb-4 lg:mr-4">
            ...
            <h3 className="text-zinc-500 scroll-m-20 text-xl font-semibold tracking-tight w-full max-w-48">
              an cli/app trivia to test you computer science fundamental knowledge of oops, js and cpp.
            </h3>
          </div>
          <div className="text-left mb-4 lg:mr-4">
            ...
            <div>
              <div className="position-relative inline-block">
                <div className="p-4 rounded-full bg-neutral-800 my-3 cursor-pointer group hover:bg-neutral-200">
                  <div className="flex flex-col items-center justify-center text-xl lg:text-3xl text-neutral-200 group-hover:text-violet-700 transition-all duration-200">
        ...
        <div class="flex flex-col items-left lg:flex-row lg:items-start justify-center">
          <div className="block max-w-5xl p-6 border-2 border-gray-500 rounded-lg shadow dark:border-gray-70 bg-custom">
            <h3 className="text-left text-xl font-bold tracking-tight text-violet-700">
